<x-dashboard-layout>
   ...
   <div class="max-w-7xl mx-auto my-6 p-4 bg-white rounded-md shadow-md">
      <div class="flex flex-col sm:w-full sm:flex-row sm:justify-between sm:items-center">
         ...
         <button id="addProductBtn"
            class="py-2 px-4 bg-green-500 text-white hover:bg-white hover:text-green-700 hover:border hover:border-green-700 rounded-md">Tambah
            Produk</button>
      </div>
   ...
   {{-- EDIT MODAL --}}
   <div id="editProductModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center">
      <div class="bg-white p-6 rounded-md shadow-md w-full max-w-md">
